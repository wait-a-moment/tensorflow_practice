...
from keras.layers import Flatten, merge, Lambda,Concatenate
...
def fit(inp_layer, inp_embed, X, y):
    ...
    input = Concatenate(axis=3)([inp_embed])
    # deep layer
    for i in range(6):
        if i == 0:
...
if __name__ == "__main__":
    ...
    data = pd.read_csv(r"D:\data\forest-cover-type-dataset\covtype.csv")
